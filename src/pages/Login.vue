  ...
  <q-page padding>
    ...
    <div class="q-pa-lg column items-center">
      ...
      <q-card class="my-card" elevated>
        <q-card-section>
          <q-img src="../img/Logo.png" class="q-gutter-sm" style="height: 150px">
        </q-img>
        </q-card-section>
        <q-card-section>
          <div class="q-pa-md">
        ...
        Ingresando
            ...
            <p class="text-center">
              No tienes una cuenta, <router-link to="RegDoc">regístrate</router-link>
            </p>
          </div>
        </q-card-section>
      </q-card>
...
export default {
  ...
  setup(){
    ...
    function LogIn(){
      ...
      api.post("Medicos/iniciarSesion", {
