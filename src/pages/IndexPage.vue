<template>
  <q-page padding>
            ...
            <div class="col-xs-12 col-md-4">
              <q-card class="my-card">
                ...
                <q-card-actions align="right">
                  <q-btn flat color="positive" @click="mdlAgendar = true"
                    >Agendar Cita</q-btn
                  >
                  ...
                  <div class="q-pa-sm row items-start q-gutter-md">
                    <q-card class="col-xs-12 text-center">
                      <q-card-section>
                        <div class="text-left">
                          <p>
                            Nombre Completo: {{ props.row.pac.nom_paciente }}
                          </p>
                        </div>
                        <div class="text-left">
    ...
    <q-dialog v-model="mdlCita" full-width>
        ...
        <q-card-section class="q-pt-none">
          ...
          <div class="row">
            <div class="col-xs-12 col-md-6 text-center">
              <q-date color="dark" v-model="fechaCita" today-btn />
              <br />
              <br />
              <q-btn
                color="dark"
    ...
    <q-dialog v-model="mdlConfirm">
      <q-card style="width: 700px; max-width: 80vw">
        ...
        <q-card-section>
          <p>
            ¿Esta seguro que desea cancelar la cita de las {{ horaInicio }}?
          </p>
        </q-card-section>
...
export default defineComponent({
  ...
  setup() {
    ...
    function consultarTopCitas() {
      api.get("Citas/consultarTopCitas", {}).then((res) => {
        console.log(res.data);
        this.citas = res.data;
      });
    }
    ...
    function insertarCitaPaciente() {
      ...
      api
        .post("Citas/insertarCitaPaciente", {
          citas: {
      ...
      api
        ...
        .then((res) => {
          ...
          if (res.data) {
            $q.notify({
              type: "positive",
              message: "Se cancelado la cita de manera exitosa.",
            });
          } else {
            $q.notify({
              type: "negative",
      ...
      api
        ...
        .then((res) => {
          ...
          if (res.data) {
            ...
            $q.notify({
              type: "negative",
              message: "Ha ocurrido un error, vuelva a intentar más tarde.",
            });
          }
        });
      //$router.push({path: '/Consultas/:' + this.idCitaDash})
      ...
      if (this.txtnom == "" || this.txtapp == "") {
        ...
        await this.registrarPacienteMix(fd).then((data) => {
          if (data) {
            $q.notify({
              type: "positive",
              message: "Se ha registrado el paciente con éxito",
            });
    ...
    async function verPaciente() {
      await this.verPacienteMix(this.slpacientes).then((data) => {
        ...
        this.urlFoto =
          ruta + data.foto_paciente.substring(10, data.foto_paciente.length);
        this.mdledit = true;
      });
    }
    ...
    async function actualizarPaciente() {
      ...
      await this.actualizarPacienteMix(
        this.idpac,
        this.txtnomEd,
        this.txtappEd,
        this.txtapmEd,
        ...
        if (data) {
          $q.notify({
            type: "positive",
            message: "Se ha actualizado el paciente con éxito",
          });
          this.mdledit = false;
        } else {
          $q.notify({
